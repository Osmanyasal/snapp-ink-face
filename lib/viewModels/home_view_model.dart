...
class HomeViewModel extends ChangeNotifier {
  ...
  final List<Map<String, String>> _filters = [
    ...
    {"filter": Filters.watercolor_3, "name": "Water Color 3"},
    {"filter": Filters.watercolor_5, "name": "Water Color 5"},
    {"filter": Filters.watercolor_8, "name": "Water Color 8"},
    {"filter": Filters.watercolor_12, "name": "Water Color 12"},
    {"filter": Filters.watercolor_16, "name": "Water Color 16"},
