...
class HomeViewModel extends ChangeNotifier {
  ...
  final List<Map<String, String>> _aiFilters = [
    ...
    {"filter": AiFilters.face_swap_enhanced, "name": "Enhance"}, 
    {"filter": AiFilters.face_swap_cv_1, "name": "cv"},
    {"filter": AiFilters.face_swap_cv_2, "name": "cv"},
    {"filter": AiFilters.face_swap_cv_3, "name": "cv"},
    {"filter": AiFilters.face_swap_cv_4, "name": "cv"},
    {"filter": AiFilters.face_swap_cv_5, "name": "cv"},
    {"filter": AiFilters.face_swap_cv_6, "name": "cv"},
    {"filter": AiFilters.face_swap_cv_7, "name": "cv"},
    {"filter": AiFilters.face_swap_cv_8, "name": "cv"},
    {"filter": AiFilters.face_swap_cv_9, "name": "cv"}, 
    {"filter": AiFilters.face_swap_cv_10, "name": "cv"}, 

    {"filter": AiFilters.face_swap_90s_1, "name": "90s"}, 
    {"filter": AiFilters.face_swap_90s_2, "name": "90s"}, 
    {"filter": AiFilters.face_swap_90s_3, "name": "90s"}, 
    {"filter": AiFilters.face_swap_90s_4, "name": "90s"}, 
    {"filter": AiFilters.face_swap_90s_5, "name": "90s"}, 
    {"filter": AiFilters.face_swap_90s_6, "name": "90s"}, 
    {"filter": AiFilters.face_swap_90s_7, "name": "90s"}, 
    {"filter": AiFilters.face_swap_90s_8, "name": "90s"}, 
    {"filter": AiFilters.face_swap_90s_9, "name": "90s"}, 
    {"filter": AiFilters.face_swap_90s_10, "name": "90s"}, 
    {"filter": AiFilters.face_swap_90s_11, "name": "90s"}, 
    {"filter": AiFilters.face_swap_90s_12, "name": "90s"}, 
    {"filter": AiFilters.face_swap_90s_13, "name": "90s"}, 
    {"filter": AiFilters.face_swap_90s_14, "name": "90s"}, 
    {"filter": AiFilters.face_swap_90s_15, "name": "90s"}, 
    {"filter": AiFilters.face_swap_90s_16, "name": "90s"}, 
    {"filter": AiFilters.face_swap_90s_17, "name": "90s"}, 
    {"filter": AiFilters.face_swap_90s_18, "name": "90s"}, 
    {"filter": AiFilters.face_swap_90s_19, "name": "90s"}, 
    {"filter": AiFilters.face_swap_90s_20, "name": "90s"}, 
    ...
    {"filter": AiFilters.face_swap_beach_7, "name": "Beach"},
    {"filter": AiFilters.face_swap_beach_8, "name": "Beach"},
    {"filter": AiFilters.face_swap_beach_9, "name": "Beach"},
    {"filter": AiFilters.face_swap_beach_10, "name": "Beach"}, 

    {"filter": AiFilters.face_swap_cyberpunk_1, "name": "Cyberpunk"},
    {"filter": AiFilters.face_swap_cyberpunk_2, "name": "Cyberpunk"},
    {"filter": AiFilters.face_swap_cyberpunk_3, "name": "Cyberpunk"},
    {"filter": AiFilters.face_swap_cyberpunk_4, "name": "Cyberpunk"},
    {"filter": AiFilters.face_swap_cyberpunk_5, "name": "Cyberpunk"},
    {"filter": AiFilters.face_swap_cyberpunk_6, "name": "Cyberpunk"}, 
    {"filter": AiFilters.face_swap_cyberpunk_7, "name": "Cyberpunk"}, 
    {"filter": AiFilters.face_swap_cyberpunk_8, "name": "Cyberpunk"}, 
    {"filter": AiFilters.face_swap_cyberpunk_9, "name": "Cyberpunk"}, 
    ...
    {"filter": AiFilters.face_swap_gym_9, "name": "Gym"},
    {"filter": AiFilters.face_swap_gym_10, "name": "Gym"},
    {"filter": AiFilters.face_swap_gym_11, "name": "Gym"},
    {"filter": AiFilters.face_swap_gym_12, "name": "Gym"},
    {"filter": AiFilters.face_swap_gym_13, "name": "Gym"},
    {"filter": AiFilters.face_swap_gym_14, "name": "Gym"}, 

    {"filter": AiFilters.face_swap_poloraid_1, "name": "Poloraid"},
    {"filter": AiFilters.face_swap_poloraid_2, "name": "Poloraid"},
    {"filter": AiFilters.face_swap_poloraid_3, "name": "Poloraid"},
    {"filter": AiFilters.face_swap_poloraid_4, "name": "Poloraid"},
    {"filter": AiFilters.face_swap_poloraid_5, "name": "Poloraid"},
    {"filter": AiFilters.face_swap_poloraid_6, "name": "Poloraid"},
    {"filter": AiFilters.face_swap_poloraid_7, "name": "Poloraid"},
    {"filter": AiFilters.face_swap_poloraid_8, "name": "Poloraid"},
    {"filter": AiFilters.face_swap_poloraid_9, "name": "Poloraid"},
    {"filter": AiFilters.face_swap_poloraid_10, "name": "Poloraid"},
